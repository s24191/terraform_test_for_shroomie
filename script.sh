...
cd myagent
./config.sh --unattended --url https://dev.azure.com/SUML-YY/ --auth pat --token FyVxMB8lQAW7doOSB3YwslaA4ppt8gjhJTGyjj97f4zeIhTJaQHWJQQJ99ALACAAAAASYbtJAAASAZDOZ0qh --pool Default --agent aksagent --acceptTeeEula
